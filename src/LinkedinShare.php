...
class LinkedinShare
{
    ...
    //mark
	//https://docs.microsoft.com/en-us/linkedin/marketing/integrations/community-management/shares/ugc-post-api#create-ugc-posts
    public function shareNoneCompany($code, $text,$orgId,$access_type = 'code')
    {
        $client = new Client();
        $access_token = ($access_type === 'code') ? $this->getAccessToken($code) : $code;
        $personURN = $this->getProfile($access_token)['id'];
